...
public class DistanceCalculator {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			//if there's an integer available, use it, otherwise default to 0 with a message
			if (inputParser.hasNextInt()) {
				x1 = inputParser.nextInt();
			} else {
				System.out.println("Invalid x1 input, using 0 instead");
				x1 = 0;
			}
			...
			if (inputParser.hasNextInt()) {
				...
				System.out.println("Invalid y1 input, using 0 intead");
				y1 = 0;
			}
			...
			if (inputParser.hasNextInt()) {
				...
				System.out.println("Invalid x2 input, using 0 instead");
				x2 = 0;
			}
			...
			if (inputParser.hasNextInt()) {
				...
				System.out.println("Invalid y2 input, using 0 intead");
				y2 = 0;
			}
			
			//print the result
			System.out.print("Distance between (" + x1 + "," + y1 + ")" 
					+ " and (" + x2 + "," + y2 +") is: ");
